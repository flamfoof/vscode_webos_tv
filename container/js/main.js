...
(function () {
  ...
  var CONTENT_PATH = '/home/owner/share/tmp/sdk_tools/SelectTVportalWITs';
  var CONTENT_SRC = '/home/owner/share/tmp/sdk_tools/SelectTVportalWITs/index.html';
  var IP = 'http://192.168.1.129';
  var PORT = '8498';
      ...
      tizen.filesystem.resolve(
        ...
        function (path) {
          path.parent.deleteDirectory(
            ...
            function (e) {
              console.log(
                '[Warning]: Failed to delete directory ' + CONTENT_PATH
              );
              connectPC();
            }
          );
